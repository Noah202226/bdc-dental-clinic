...
export default function ReportsAnalytics() {
  ...
  const handleExportPDF = async () => {
    try {
      ...
      // header
      doc.setFontSize(16);
      doc.text("DBC Dental Reports & Analytics", 14, 15);
      doc.setFontSize(10);
      ...
      doc.text(
        `Generated by DBC-Dental • ${new Date().getFullYear()}`,
        14,
        290
      );
      ...
      doc.save(`DBC-Dental_${activeTab}_Report_${safeDate}.pdf`);
    } catch (err) {
            ...
            <div className="card border border-green-300/40 shadow-sm rounded-xl overflow-hidden">
              ...
              <div className="hidden md:block overflow-x-auto">
                <table className="table">
                  ...
                  <tbody className="bg-[var(--theme-color)]">
                    {allPayments.map((p) => (
                      <tr
                        key={p.id}
